...
public final class Board extends Observable
{
  ...
  //METHOD ADDED TO CLEANLY END GAME FOR END GAME FUNCTION
  //Jeremiah Stowe
  //Spring 2013
  /**
   * Method to end current game status.
   */
  public void endGame()
  {
  ...
  {
    //Added local var to report back lines removed
    //Jeremiah Stowe
    //Spring 2013
    Integer lines_removed = 0;
    ...
    //Send to the observers lines removed
    //Jeremiah Stowe
    //Spring 2013
    notifyObservers(lines_removed);
  }
